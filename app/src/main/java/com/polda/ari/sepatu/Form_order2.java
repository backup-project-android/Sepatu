...
public class Form_order2 extends AppCompatActivity {
    EditText txt_alamat,txt_nama_p,txt_nohp,txt_jum1,txt_jum2,txt_ket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_form_order2);
        getSupportActionBar().setTitle("Deep Cleaning");
            ...
            public void onClick(View v) {
                ...
                if(txt_nama_p.getText().toString().equals("")||txt_alamat.getText().toString().equals("")||
                    ...
                    simpanOrder(txt_nama_p.getText().toString().trim(), txt_alamat.getText().toString().trim(),
                            ...
                            txt_nohp.getText().toString().trim(), sepatu, tas,kal1,kal2,txt_ket.getText().toString().trim(),
                            sp_name.getSelectedItem().toString().trim(), "Deep Cleaning","0");
                }
    ...
    public void simpanOrder(final String Nama_p, final String Alamat_p,
                            final String Lati, final String Longi, final String No_hp,
                            final String Item1, final String Item2,
                            final Integer Jumlah1,final Integer Jumlah2, final String Keterangan, final String Tipe, final String Status,
                            final String Bayar){
//Toast.makeText(getApplication(),"Data "+Item2,Toast.LENGTH_LONG).show();
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result) {
                ...
                if(result.equalsIgnoreCase("success")){
                    dialogs
                            .withTitle("Informasi")
                            .withMessage("Order Deep Cleaning berhasil")
                    ...
                    dialogs.setButton1Click(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if(sp_name.getSelectedItem().toString().equals("Transfer Rekening")){
                                Intent intent = new Intent(Form_order2.this, Frm_invoice.class);
                                startActivity(intent);
                            }else if(sp_name.getSelectedItem().toString().equals("Tunai")){
                                Intent intent = new Intent(Form_order2.this, Frm_invoice2.class);
                                startActivity(intent);
                            }
                        }
                    });
        ...
        sendPostReqAsyncTask.execute(Nama_p,Alamat_p,Lati,Longi,No_hp,Item1,Item2,String.valueOf(Jumlah1),String.valueOf(Jumlah2),Tipe,Status,Bayar);
