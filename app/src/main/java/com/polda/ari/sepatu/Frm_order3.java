...
public class Frm_order3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm_order3);
        getSupportActionBar().setTitle("Repaint");
            ...
            public void onClick(View v) {
                ...
                if(txt_nama_p.getText().toString().equals("")||txt_alamat.getText().toString().equals("")||
                    ...
                    simpanOrder(txt_nama_p.getText().toString().trim(), txt_alamat.getText().toString().trim(),
                            ...
                            sp_name.getSelectedItem().toString().trim(), "Repaint","0");
                }
        ...
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result) {
                ...
                if(result.equalsIgnoreCase("success")){
                    dialogs
                            .withTitle("Informasi")
                            .withMessage("Order Repaint berhasil")
                    ...
                    dialogs.setButton1Click(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if(sp_name.getSelectedItem().toString().equals("Transfer Rekening")){
                                Intent intent = new Intent(Frm_order3.this, Frm_invoice.class);
                                startActivity(intent);
                            }else if(sp_name.getSelectedItem().toString().equals("Tunai")){
                                Intent intent = new Intent(Frm_order3.this, Frm_invoice2.class);
                                startActivity(intent);
                            }
                        }
                    });
